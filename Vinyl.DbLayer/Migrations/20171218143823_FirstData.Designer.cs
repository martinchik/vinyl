            ...
            modelBuilder.Entity("Vinyl.DbLayer.Models.RecordArt", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 12, 18, 14, 38, 23, 512, DateTimeKind.Utc));
            ...
            modelBuilder.Entity("Vinyl.DbLayer.Models.RecordInShopLink", b =>
                {
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 12, 18, 14, 38, 23, 513, DateTimeKind.Utc));
            ...
            modelBuilder.Entity("Vinyl.DbLayer.Models.ShopInfo", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 12, 18, 14, 38, 23, 514, DateTimeKind.Utc));
            ...
            modelBuilder.Entity("Vinyl.DbLayer.Models.ShopParseStrategyInfo", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 12, 18, 14, 38, 23, 515, DateTimeKind.Utc));
